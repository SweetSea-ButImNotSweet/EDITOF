...
do
    ...
    baseWidgetDict={
        ...
        slider_progress={type='slider_progress',x=0,y=0,w=300,      text ='My internal name is slider_progress',disp=function() return slider_progressR end,code=function(v) slider_progressR=v end,axis={0,100   }},
